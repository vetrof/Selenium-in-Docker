...
from selenium_test.models import UuId
...
def start_script(request):
    print('________------______----_______----____---__')
    options = Options()
    ...
    UuId.objects.create(field=unique_filename)
    print('________------______----_______----____---__')
    return HttpResponse(f'{unique_filename}')
